...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Rana MZ : ZESHi
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;94mWrong Password"
            os.system('xdg-open www.facebook.com/RE4L.H4CK3R.com')
    else:
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(\x1b[1;95mBABA KHATRA) ' + k + c + user + '  |  ' + pass1
